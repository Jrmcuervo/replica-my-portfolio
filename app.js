...
const projects = [
  {
    title: 'Awesome Books',
    img: 'images/SS-awesome-books.jpg',
    client: 'Microverse',
    role: 'Front End',
    year: '2023',
    desc: 'Awesome Books is a simple library that allows users to store a list of books along with their respective authors. It also generates dynamic content for an interactive user experience.',
    tech: ['HTML', 'CSS', 'JavaScript'],
    button: 'See project',
    github: 'https://github.com/Jrmcuervo/awesome-books',
    live: 'https://jrmcuervo.github.io/awesome-books/',
  },
  {
    title: 'To Do List',
    img: 'images/SS-ToDoList.jpg',
    client: 'Microverse',
    role: 'Front End',
    year: '2023',
    desc: 'To Do List is an app that helps users manage their tasks with features like adding, completing, and deleting items from the list. It uses webpack for efficient bundling.',
    tech: ['HTML', 'CSS', 'JavaScript'],
    button: 'See project',
    github: 'https://github.com/Jrmcuervo/To-do-list',
    live: 'https://jrmcuervo.github.io/To-do-list/dist/',
  },
  {
    title: 'Tonic',
